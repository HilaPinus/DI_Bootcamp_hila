...
// then append the gif to the page. Use this documentation https://developers.giphy.com/docs/api/endpoint#random 
...
// For example: you will fetch the random-word-api. This api will return a random word - 
// for example : "happy" Using this word as a category, you will fetch one random 
// gif with the category of "happy" and display it on the page
