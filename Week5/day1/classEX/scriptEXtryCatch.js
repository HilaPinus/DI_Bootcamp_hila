...
//Your function should return "You are signed in". 
//However, if the email doesn't contain @ you should throw the error, "Missing @ in the email." (edited) 
