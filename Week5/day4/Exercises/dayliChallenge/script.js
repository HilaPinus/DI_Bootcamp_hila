...
form.addEventListener("submit", handelSubmut);

function handelSubmut (e) {
    e.preventDefault();
    console.log(form.elements);
    const city1lat = form.elements[0].value;
    const city1long = form.elements[1].value;
    const city2lat = form.elements[2].value;
    const city2long = form.elements[3].value;
console.log(city1lat, city1long, city2lat, city2long);
